  ...
  return <div className="min-h-screen brown-gradient p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center">
          ...
          {currentQuestion === questions.length - 1 ? <Button onClick={handleSubmit} disabled={isSubmitting || selectedAnswers.length !== questions.length} className="bg-white text-primary hover:bg-white/90 interactive-button h-12 px-6">
